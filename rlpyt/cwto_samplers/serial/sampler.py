...
from rlpyt.cwto_samplers.parallel.cpu.collectors import CpuResetCollector
...
class SerialSampler(BaseSampler):
    ...
    def obtain_samples(self, itr):
        ...
        player_agent_inputs, player_traj_infos, player_completed_infos, observer_agent_inputs, observer_traj_infos, observer_completed_infos = self.collector.collect_batch(
            self.player_agent_inputs, self.observer_agent_inputs, self.player_traj_infos, self.observer_traj_infos, itr)
        self.collector.reset_if_needed(player_agent_inputs, observer_agent_inputs)
        self.player_agent_inputs = player_agent_inputs
        self.observer_agent_inputs = observer_agent_inputs
        self.player_traj_infos = player_traj_infos
        self.observer_traj_infos = observer_traj_infos
        return self.player_samples_pyt, player_completed_infos, self.observer_samples_pyt, observer_completed_infos
